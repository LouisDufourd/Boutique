                ...
                <div class="col-md-3 mb-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p>Owner : ${store.utilisateur.username}</p>
                            <a href="/stores/${store.boutique.id}" class="btn btn-primary">Manage</a>
                            <#if data.roles[store_index] == 1>
                                <a href="/stores/${store.boutique.id}/delete" class="btn btn-danger">Remove</a>
                            </#if>
                        </div>
                    </div>
                </div>
